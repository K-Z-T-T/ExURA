...
public class NetherstarGeneratorScreen extends AbstractContainerScreen<NetherstarGeneratorMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ExURA.MODID, "textures/screen/jhj.png");

    public NetherstarGeneratorScreen(NetherstarGeneratorMenu menu, Inventory inv, Component title) {
