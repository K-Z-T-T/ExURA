...
public class ResonatorScreen extends AbstractContainerScreen<ResonatorMenu> {
    public static final ResourceLocation GUI_TEXTURE = ResourceLocation.fromNamespaceAndPath(ExURA.MODID,
            "textures/screen/jhj.png");
    public static final ResourceLocation ARROW_TEXTURE = ResourceLocation.fromNamespaceAndPath(ExURA.MODID,
            "textures/screen/arrow_progress.png");

    public ResonatorScreen(ResonatorMenu p_97741_, Inventory p_97742_, Component p_97743_) {
