...
public class HalitosisGeneratorScreen extends AbstractContainerScreen<HalitosisGeneratorMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ExURA.MODID, "textures/screen/jhj.png");

    public HalitosisGeneratorScreen(HalitosisGeneratorMenu menu, Inventory inv, Component title) {
