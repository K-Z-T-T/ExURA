...
public class DeathGeneratorScreen extends AbstractContainerScreen<DeathGeneratorMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ExURA.MODID, "textures/screen/jhj.png");

    public DeathGeneratorScreen(DeathGeneratorMenu menu, Inventory inv, Component title) {
