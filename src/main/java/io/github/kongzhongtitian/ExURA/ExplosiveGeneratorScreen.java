...
public class ExplosiveGeneratorScreen extends AbstractContainerScreen<ExplosiveGeneratorMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ExURA.MODID, "textures/screen/jhj.png");

    public ExplosiveGeneratorScreen(ExplosiveGeneratorMenu menu, Inventory inv, Component title) {
