...
public class SurvivalGeneratorScreen extends AbstractContainerScreen<SurvivalGeneratorMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ExURA.MODID, "textures/screen/jhj.png");

    public SurvivalGeneratorScreen(SurvivalGeneratorMenu menu, Inventory inv, Component title) {
