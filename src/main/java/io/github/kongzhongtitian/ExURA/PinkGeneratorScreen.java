...
public class PinkGeneratorScreen extends AbstractContainerScreen<PinkGeneratorMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ExURA.MODID, "textures/screen/jhj.png");

    public PinkGeneratorScreen(PinkGeneratorMenu menu, Inventory inv, Component title) {
