...
public class DemonicallyGargantuanDrumBlockEntity extends BlockEntity {
    ...
    public DemonicallyGargantuanDrumBlockEntity(BlockPos pos, BlockState state) {
        super(ExURABlockEntity.DEMONICALLY_GARGANTUAN_DRUM_BLOCK_ENTITY.get(), pos, state);
    }
